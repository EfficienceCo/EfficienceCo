...
-- Rollback: reverter o agente antes de executar:
-- DROP TRIGGER IF EXISTS trigger_versionar_mutacao_regras ON public.regras;
-- DROP FUNCTION IF EXISTS public.versionar_mutacao_regras();
-- Preservar versao/regras_versao: podem existir de instalações anteriores (#286).
