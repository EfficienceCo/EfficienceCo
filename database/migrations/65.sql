-- Função que mantém clientes.total_usuarios em sincronia com usuarios
...
-- Trigger em usuarios
DROP TRIGGER IF EXISTS tr_atualizar_total_usuarios ON usuarios;
CREATE TRIGGER tr_atualizar_total_usuarios
  AFTER INSERT OR DELETE ON usuarios
  FOR EACH ROW EXECUTE FUNCTION gerenciar_contador_usuarios();