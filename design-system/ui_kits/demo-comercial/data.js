...
var AUTOMACOES = [
  ...
  { id:'emissao-das-darf', area:'fiscal', ic:'guia', nome:'Emissão de Guias (DAS/DARF)', desc:'Depois de apurado, todo imposto precisa virar um boleto de verdade — com código de barras, vencimento e os dados do contribuinte. O agente organiza o valor já apurado no layout da guia, deixando pronta a base para a emissão oficial junto ao governo.', tipo:'bespoke' },
